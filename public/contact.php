...
if (isset($_POST['send'])) {
  ...
  $OK = false;
  //update query
  $sql = 'INSERT INTO fanclub (firstname, lastname, email, newsletter, join_club)
          VALUES(:firstname, :lastname, :email, :newsletter, :join_club)';
  ...
  $stmt->bindParam(':join_club', $_POST['join_club']);
  ...
  //list of expected fields
    $expected = ['firstname', 'lastname', 'email', 'address', 'city', 'state', 'Zip', 'comments', 'newsletter', 'join_club'];
    $required = ['firstname', 'lastname', 'email', 'newsletter', 'join_club'];
...
<div class="row test">
  <form method="post" class="container myform" id="contact">
      ...
      <div class="col-md-8">
        ...
        <div class="row">
          <div class="col-md-12 form-group">
            ...
            <br>
            <input type="checkbox" checked="checked" name="join_club">
