...
<?php
  if (isset($_POST['insert'])) {
      ...
      if ($stmt->prepare($sql)) {
          // bind parameters and execute statement
          $stmt->bind_param('si', $_POST['album_title'], $_POST['album_year']);
          $stmt->execute();
...
<div id="content ">
  ...
  <div class="subject listing container-fluid text-center">
    ...
    <form action="" method="post" enctype="multipart/form-data" id="uploadImage">
      ...
      <div id="operations">
        <p>
          <input type="submit" value="Create Album" name="insert"/>
        </p>
        <p>
          <label for="next">Would you like to add an Album Image?
